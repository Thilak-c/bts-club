    ...
    <div className="min-h-screen flex flex-col bg-[--bg]">
      ...
      <div className="p-6 flex items-center justify-between opacity-0 animate-fade-in" style={{animationDelay: '0.1s', animationFillMode: 'forwards'}}>
        <div className="flex items-center gap-2.5">
          <img src={brandLogo} alt={brandName} className="h-7 w-7 rounded-full object-contain opacity-90" />
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full text-left p-6 rounded-xl bg-[--card] border border-[--border] hover:border-[--text-dim] transition-all duration-200 active:scale-[0.99] opacity-0 animate-slide-up"
            style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-lg bg-[--bg] flex items-center justify-center">
